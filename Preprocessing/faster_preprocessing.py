...
def get_nuts_dataloader(image_dir, label_dir):
    ...
    valid_image = r"C:\Users\user\Downloads\Deep_Learning_Gicho\Data\NutsDataSet\valid\image"
    valid_label = r"C:\Users\user\Downloads\Deep_Learning_Gicho\Data\NutsDataSet\valid\label"

    train_files, valid_files = split_json_files(label_dir, ratio=0.8, seed=42) #8:2의 비율로 파일 나눔

    copy_split_files(train_files, image_dir, label_dir, train_image, train_label) #분리된 train_files 생성
    copy_split_files(valid_files, image_dir, label_dir, valid_image, valid_label) #분리된 valid_files 생성

    train_ds = NutsDataSet(train_image, train_label) #train 데이터셋 생성
    valid_ds = NutsDataSet(valid_image, valid_label) #valid 데이터셋 생성
...
#     out_image_dir = r"C:\Users\user\Downloads\Deep_Learning_Gicho\Data\NutsDataSet\sample_image"
#     out_label_dir = r"C:\Users\user\Downloads\Deep_Learning_Gicho\Data\NutsDataSet\sample_label"
...
# nuts = NutsDataSet(image_dir=image_dir, label_dir=label_dir, transforms=trans)
# print(nuts.samples)
